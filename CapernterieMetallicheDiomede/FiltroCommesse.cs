    ...
    public partial class FiltroCommesse : Form
    {
        ...
        private void FiltroCommesse_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                comboBox1.Items.Add("TECNICO INTERNO");
        ...
        private void ComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedItem.Equals("DITTA"))
            ...
            else if (comboBox1.SelectedItem.Equals("INDIRIZZO CANTIERE"))
                foreach (var c in lista)
                {
                    var flag = true;
                    foreach (var o in comboBox2.Items)
            ...
            else if (comboBox1.SelectedItem.Equals("TECNICO INTERNO"))
                foreach (var c in lista)
                {
                    var flag = true;
                    foreach (var o in comboBox2.Items)
            ...
            else if (comboBox1.SelectedItem.Equals("DATA ESECUZIONE"))
                foreach (var c in lista)
                {
                    var flag = true;
                    foreach (var o in comboBox2.Items)
            ...
            else if (comboBox1.SelectedItem.Equals("DATA RICHIESTA CONSEGNA"))
                foreach (var c in lista)
                {
                    var flag = true;
                    foreach (var o in comboBox2.Items)
                ...
                foreach (var c in lista)
                {
                    var flag = true;
                    foreach (var o in comboBox2.Items)
                        if (c.DataEsecuzione.ToString("yyyy/MM/dd hh:mm").Equals(o.ToString()))
                        {
                            flag = false;
                            break;
                        }

                    if (flag) comboBox2.Items.Add(c.DataEsecuzione.ToString("yyyy/MM/dd hh:mm"));
                }
        }
    }
}
