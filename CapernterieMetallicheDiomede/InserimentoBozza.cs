        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (listaAmministrazione.Count <= 0)
                {
                    ...
                    commessa = op1.GeneraCommessa("PO/B", listaCliente[listaCliente.Count - 1], "PraticheEdili", true, double.Parse(textBox1.Text));
                }
                else
                {
                    commessa = op1.GeneraCommessa("PO/B", listaAmministrazione[0], "PraticheEdili", true, double.Parse(textBox1.Text));
                }
