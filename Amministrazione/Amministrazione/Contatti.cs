    ...
    public partial class Contatti : Form
    {
        ...
        private void Form7_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    var lista = op.FiltraContratto("CLIENTI", "" + cliente.Id);
                    if (lista != null)
                    {
                        dataGridView1.DataSource = lista;
                        dataGridView1.Columns[0].Visible = false;
                    ...
                    if (riga.Cells[0].Style.ForeColor == Color.Red)
                        try
                        {
                            op.UpdateContatto((int) riga.Cells["ID"].Value, riga.Cells["NOME"].Value + "",
                                ...
                                riga.Cells["EMAIL"].Value + "", riga.Cells["PARTITAIVA"].Value + "",
                                (int) riga.Cells["CLIENTI"].Value, riga.Cells["TELEFONOCELLULARE"].Value + "",
                                riga.Cells["TELEFONOFISSO"].Value + "", riga.Cells["RUOLO"].Value + "");
                        }
                        catch
                        {
                ...
                if (MessageBox.Show(
                    ...
                    try
                    {
                        var clienti = op.CercaContattoId((int) dataGridView1.Rows[dataGridView1.SelectedRows[0].Index]
                            .Cells[0].Value);
                        op.CancellaContatto((int) dataGridView1.Rows[dataGridView1.SelectedRows[0].Index].Cells[0]
                            .Value);
